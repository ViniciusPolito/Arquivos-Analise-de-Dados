...
grep(pattern= "[cmf]an", txt, value= TRUE)#[cmf]an
#Q4
install.packages("stringr")
library("stringr")
txt = "eeer3GHJca1nfgSigmanfaUIOntafan"
str_extract_all(string=txt,pattern="\\d|[A-Z]")
#Q5
txt = "eeer3GHJca1nfgSigmanfaUIOntafan"
str_extract_all(string=txt,pattern="[[:upper:]|[:digit:]]")
#Q6
txt = "tttyUFRPE19PPGIAkjgkjghk2j34j321UFRPEcapdPPGIA"
str_extract_all(string=txt,pattern="UFRPE[a-z0-9]{2,4}PPGIA")
#Q7
...
str_extract_all(string=txt,pattern="([Nn]egr[oa]s?)")#??
#Q.X
aux<- read.delim("https://www.dropbox.com/s/4yr2woj8r1p5sbn/gapminderDataFiveYear.txt?dl=1")

str_extract_all(string=aux,pattern="([a-zA-Z\\s]*and[a-zA-Z\\s]*)(?!.*\\1)")
#Q.X+1
str_extract_all(string=aux,pattern="^(Ba)(.*)(land)$")
